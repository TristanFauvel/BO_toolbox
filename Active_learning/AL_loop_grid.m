function [xtrain, ytrain, cum_regret, score]= AL_loop_grid(x, y, maxiter, nopt, kernelfun, meanfun, theta, acquisition_fun, ninit, hyp_lb, hyp_ub, lb, ub, seed)
...
for i =1:maxiter
    ...
    if i > ninit
        ...
        hyp = multistart_minConf(@(hyp)minimize_negloglike(hyp, xtrain_norm(:,1:i), ytrain(:,1:i), kernelfun, meanfun, ncov_hyp, nmean_hyp, update), hyp_lb, hyp_ub,10, init_guess, options_theta); 
