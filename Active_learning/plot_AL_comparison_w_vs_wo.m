function plot_AL_comparison_w_vs_wo(objectives, objectives_names, acquisition_funs, names, figure_folder,data_dir, figname, nreps, maxiter, rescaling)
...
for j = 1:nobj
    ...
    clear('score')
    for a = 1:2
        acquisition = acquisition_funs{1};
        
        filename = [data_dir,'/',objective, '_',acquisition, '_', num2str(a-1)];
