...
new_x_norm = multistart_minConf(@(x)  Entropic_epistemic_uncertainty(theta, xtrain_norm, ctrain, x, model, post), model.lb_norm, model.ub_norm, ncandidates, init_guess, options, 'objective', 'max');
