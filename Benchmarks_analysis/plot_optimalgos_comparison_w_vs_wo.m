function plot_optimalgos_comparison_w_vs_wo(objectives, objectives_names, acquisition_funs, names, figure_folder,data_dir_w, data_dir_wo, figname, nreps, maxiter, rescaling)
