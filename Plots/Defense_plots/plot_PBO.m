...
hyps = 
model = gp_classification_model(D, meanfun, kernelfun, regularization ,hyps , lb, ub , type, link, ...
    modeltype, kernelname, condition);
post = [];
...
nexttile
i=i+1;
plot_gp(x, mu_g, sigma2_g, C(1,:), linewidth, 'background', background); hold on;
