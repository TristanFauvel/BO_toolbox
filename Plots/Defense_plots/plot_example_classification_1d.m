...
nexttile();
i=i+1;
[p1, p2] = plot_distro(x, mu_c, Y, C(3,:), C(1,:),linewidth,'background', background);
...
nexttile();
i=i+1;
p1 = plot_gp(x,mu_y, sigma2_y, C(1,:),linewidth, 'background', background);
...
darkBackground(fig,0.1373*[1 1 1],[1 1 1])
