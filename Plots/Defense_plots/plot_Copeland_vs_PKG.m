...
[xbest, ybest] = model.maxmean(theta, xtrain, ctrain, post);
...
set(c, 'XTick', [0,1]);
colormap(cmap)
p1 = scatter(xtrain(1, ctrain(1:ntr)==1),xtrain(2, ctrain(1:ntr)==1), markersize, 'MarkerFaceColor', k, 'MarkerEdgeColor', w) ;
p2 = scatter(xtrain(1, ctrain(1:ntr)==0),xtrain(2, ctrain(1:ntr)==0), markersize, 'MarkerFaceColor', w, 'MarkerEdgeColor', k) ;
...
% set(c, 'XTick', [0,1]);
colormap(cmap)
p1 = scatter(xtrain(1, ctrain(1:ntr)==1),xtrain(2, ctrain(1:ntr)==1), markersize, 'MarkerFaceColor', w, 'MarkerEdgeColor', k) ; hold on;
p2 = scatter(xtrain(1, ctrain(1:ntr)==0),xtrain(2, ctrain(1:ntr)==0), markersize, 'MarkerFaceColor', k, 'MarkerEdgeColor', w) ; hold off;
legend([p1, p2], '$c=1$', '$c=0$','Fontsize',Fontsize, 'Location', 'northeast')
legend box off
