...
[~, value, ~, ~] = prediction_bin_preference(theta, xtrain, ctrain, [x; 0.5*ones(d,n)], kernelfun, kernelname,'modeltype', modeltype);
sum_value = value + value';
[mu_c,  mu_y, ~, Sigma2_y] = prediction_bin_preference(theta, xtrain, ctrain, xduels, kernelfun, kernelname,'modeltype', modeltype);
