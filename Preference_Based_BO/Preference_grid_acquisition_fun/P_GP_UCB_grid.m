...
[~, value, ~, ~] = model.prediction(theta, xtrain, ctrain, [x; 0.5*ones(d,n)], kernelfun, kernelname,modeltype, post, regularization);
sum_value = value + value';
[mu_c,  mu_y, ~, Sigma2_y] = model.prediction(theta, xtrain, ctrain, xduels, kernelfun, kernelname,modeltype, post, regularization);
