...
x0 = x(:,1);
[mu_c,  mu_y, sigma2_y] = prediction_bin_preference(theta, xtrain, ctrain, [x; x0*ones(1,ntest^d)], kernelfun,kernelname, 'modeltype', modeltype, 'post', post);

[mu_c_acq,  mu_y_acq, sigma2_y_acq] = prediction_bin_preference(theta, xtrain, ctrain, xduels, kernelfun, kernelname,'modeltype', modeltype, 'post', post);
