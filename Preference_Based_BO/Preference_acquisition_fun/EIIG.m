function  [new_x, new_x_norm] = EIIG(theta, xtrain_norm, ctrain, model, post, approximation, optim)
% EIIG, (Benavoli 2020)
...
x_duel2_norm = optimize_AF(@(x)eiig(theta, xtrain_norm, x, ctrain, model, x_duel1_norm, post), model.lb_norm, model.ub_norm, ncandidates, init_guess, options);
...
[I, dIdx]= Entropic_epistemic_uncertainty(theta, xtrain_norm, ctrain, [x;xduel1_norm],model, post);
